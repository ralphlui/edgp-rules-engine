...
def validate_column_values_to_be_decreasing(data: List[Dict[str, Any]], rule: Rule) -> Dict[str, Any]:
    """
    Validate that column values are decreasing using Great Expectations.
