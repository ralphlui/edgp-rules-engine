...
def validate_column_values_to_be_increasing(data: List[Dict[str, Any]], rule: Rule) -> Dict[str, Any]:
    """
    Validate that column values are increasing using Great Expectations.
