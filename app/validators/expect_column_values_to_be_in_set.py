...
def validate_column_values_to_be_in_set(data: List[Dict[str, Any]], rule: Rule) -> Dict[str, Any]:
    """
    Validate that column values are within a specified set using Great Expectations.
