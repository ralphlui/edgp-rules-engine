...
def validate_column_max_to_be_between(data: List[Dict[str, Any]], rule: Rule) -> Dict[str, Any]:
    """
    Validate that column maximum value is between min and max values using Great Expectations.
