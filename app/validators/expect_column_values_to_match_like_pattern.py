...
def validate_column_values_to_match_like_pattern(data: List[Dict[str, Any]], rule: Rule) -> Dict[str, Any]:
    """
    Validate that column values match a LIKE pattern using Great Expectations.
