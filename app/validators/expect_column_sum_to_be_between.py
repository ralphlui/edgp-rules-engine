...
def validate_column_sum_to_be_between(data: List[Dict[str, Any]], rule: Rule) -> Dict[str, Any]:
    """
    Validate that column sum is between min and max values using Great Expectations.
